...
export default function HelpPage() {
  const items = [
    ...
    { icon: <Mail size={18} />, title: 'Contact Support', desc: 'Reach us at hello@neuralvault.ai — we reply within 24 hours on business days.', tone: '#F59E0B' },
  ]
  return (
    <div>
      <PageTitle
      ...
      <Card style={{ marginTop: 20, display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <p style={{ color: '#94A3B8', fontSize: 13 }}>
          Still stuck? Email <span style={{ color: '#0EA5E9', fontWeight: 600 }}>hello@neuralvault.ai</span> or use the in-app chat (coming soon).
        </p>
      </Card>
    </div>
  )
